...
export default function Intro() {
  return (
    <section className='relative flex min-h-[75vh] flex-col items-start justify-center overflow-hidden bg-white pt-24 pb-16 text-black sm:min-h-[85vh] sm:pt-28 sm:pb-24 md:pb-32 dark:bg-transparent dark:text-white'>
      ...
      <div className='relative grid w-full items-center gap-10 lg:grid-cols-[1fr_380px]'>
          ...
          <div className='space-y-6'>
            <div className='group flex items-start gap-4'>
              ...
              <p className='max-w-2xl text-lg leading-relaxed text-black/70 dark:text-white/70'>
                ...
                <span className='font-semibold'>modern</span> digital
                experiences from the heart of the Philippines.
              </p>
            </div>
